...
import profilePhoto from '../assets/signal-2025-10-27-130704_002.jpeg';
    ...
    <>
      <style>{`
        ...
        .sl-profile-photo {
          ...
          object-fit: contain;
          transform: none;
          border: 2px solid rgba(227,219,187,0.7);
          box-shadow: 0 10px 28px rgba(0,0,0,0.28);
          background: rgba(248,243,225,0.2);
        }

        .sl-profile-quote {
          margin: 0;
          color: rgba(248,243,225,0.88);
          font-size: 12px;
          line-height: 1.5;
          max-width: 180px;
        }
      ...
      <div className="sl-page">
        <div className="sl-video-wrap">
          <video ref={videoRef} className="sl-video" muted playsInline autoPlay loop>
        ...
        <div className="sl-layout">
          <div className="sl-profile-panel">
            ...
            />
            <p className="sl-profile-quote">
              "I'm the kind of person who finds peace only after solving what bothers me(only errors in the world)."
            </p>
            <p className="sl-profile-sign">-Dhairya Shah</p>
          </div>
